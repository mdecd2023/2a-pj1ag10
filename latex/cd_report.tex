...
{
\vspace{0.5em}
cd2023 2a-pj1ag10分組報告}\\[18pt]
%設定文字盒子 [方框寬度的1.5倍寬][對其方式為文字平均分分布於方框中]\\距離下方18pt
\vspace{1em} %下移
\fontsize{30pt}{1pt}\selectfont\textbf{泡泡機器人設計}\\
\vspace{1em}
\sectionef\fontsize{30pt}{1em}\selectfont\textbf
{
\vspace{0.5em}
bubbleRob Tutorial Design}
 \vspace{2em}
%=---------------------參與人員-----------------------=%             
\end{center}
\begin{flushleft}
...
\hspace{32mm}\makebox[5cm][s]
{學\qquad 生：\quad 第\quad 一\quad 位\quad(41023119)}\\[6pt]
\hspace{32mm}\makebox[5cm][s]
{\hspace{36.5mm}第\quad 二\quad 位\quad(41023138)}\\[6pt]
...
%=---------------報告製作核可證明---------------------=%
 ...
 {\begin{center}
    ...
    {\begin{minipage}[t]{10em}\underline{四設二甲\enspace 41023119 第一位}\\ \underline{四設二甲\enspace 41023138\enspace 第二位}\\ %下劃線符號指令
    \end{minipage}}
         \par} %結束指定行距
    {\renewcommand\baselinestretch{1.2}\selectfont %設定以下行距
    {\begin{textblock}{30}(1.8,4)
    \noindent \fontsize{16pt}{16pt}\selectfont 分組報告題目\enspace ：泡泡機器人設計
    \hspace*{\fill} \\
    \hspace*{\fill} \\
